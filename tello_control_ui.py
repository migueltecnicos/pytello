...
class TelloUI:
    ...
    def __init__(self,tello,outputpath):
        ...
        # create buttons
        self.btn_snapshot = tki.Button(self.root, text="Captura!",
        ...
        self.btn_landing = tki.Button(
            self.root, text="Abrir panel de comandos", relief="raised", command=self.openCmdWindow)
        ...
        self.root.wm_title("Controlador de Tello. Realizado por Miguel A. Sanchez")
    ...
    def openCmdWindow(self):
        ...
        panel.wm_title("Panel de comandos")
        ...
        self.btn_landing = tki.Button(
            panel, text="Aterrizar (Land)", relief="raised", command=self.telloLanding)
        self.btn_landing.pack(side="bottom", fill="both",
                              expand="yes", padx=10, pady=5)

        self.btn_takeoff = tki.Button(
            panel, text="Despegar (Takeoff)", relief="raised", command=self.telloTakeOff)
        ...
        self.btn_landing = tki.Button(
            panel, text="Acrobacia (Flip)", relief="raised", command=self.openFlipWindow)
        self.btn_landing.pack(side="bottom", fill="both",
                              expand="yes", padx=10, pady=5)
